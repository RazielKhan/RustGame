//! The concept and implementation of the StepQueue is borrowed from Matthew Michelotti.
//! This design concept helped to resolve some input issues I was having
//! with the player character. This class is borrowed and not modified
//! from his gate_demo on Github:
//! http://www.matthewmichelotti.com/games/gate_demo/
